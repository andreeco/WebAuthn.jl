...
For a simpler, secure approach, call [`verify_registration_response`](@ref) to run all checks at once!
...
Or use [`verify_authentication_response`](@ref) for the recommended unified 
approach.
...
|                | Parse & verify   | [`verify_registration_response`](@ref) **or** [`parse_attestation_object`](@ref), [`parse_clientdata_json`](@ref), [`verify_challenge`](@ref), [`extract_credential_public_key`](@ref), [`cose_key_parse`](@ref), [`verify_attestation_object`](@ref) |
| Authentication | Build options    | [`authentication_options`](@ref)                                                                                                                  |
|                | Parse & verify   | [`verify_authentication_response`](@ref) **or** [`parse_assertion`](@ref), [`parse_clientdata_json`](@ref), [`verify_challenge`](@ref), [`verify_webauthn_signature`](@ref)                                  |

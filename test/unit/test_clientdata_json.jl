...
@testset "clientDataJSON Parse/Checks" begin
    ...
    # Why Exception? JSON3 may throw ArgumentError for utf8, JSON3.Error for bad structure.
    ...
    # 8. Wrong type (for reg/login ceremony, app code must verify, parser accepts)
    ...
    # 12. Edge: "type" field as non-string (should parse, but app will error if strict)

...
# -----------------------------------------------------------------------------
# Purpose: Ensure CBOR→UTF8→JSON, correct parsing, strict error/edge rules.
# SPEC_IDs:
#   §5.8.1-ClientData-RequiredFields – Fields required, type/JSON shape.
#   §7.1-Registration-Verify-ClientData-Type/Challenge/Origin
#   §7.2-Authentication-Verify-ClientData-Type/Challenge/Origin
#
using Test, WebAuthn, JSON3

# SPEC_ID: §5.8.1-ClientData-RequiredFields
# SPEC_ID: §7.1-Registration-Verify-ClientData-Type
# SPEC_ID: §7.1-Registration-Verify-Challenge
# SPEC_ID: §7.1-Registration-Verify-Origin
...
# SPEC_ID: §5.1-response-AuthenticatorResponse
# SPEC_ID: §5.2-AuthenticatorResponse-clientDataJSON
# SPEC_ID: §5.8.1.2-LimitedVerificationAlgorithm
# SPEC_ID: §7.1-7.2-Registration-Authentication-Fuzz
@testset "clientDataJSON Parse/Checks" begin
    ...
    @test parsed["type"] == "webauthn.create"                  # §5.8.1
    ...
    dict_tb = merge(good_dict, Dict("tokenBinding" => Dict("status" => "supported")))

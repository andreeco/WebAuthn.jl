...
@testset "EC2 Good" begin
    cose_b = UInt8[165, 1, 2, 3, 38, 32, 1, 33, 88, 32, 83, 171, 141, 121, 88,
        18, 46, 173, 166, 127, 160, 40, 92, 178, 249, 182, 70, 196, 88, 55, 61, 5,
        159, 127, 243, 218, 165, 3, 67, 116, 60, 81, 34, 88, 32, 123, 247, 82, 170,
        104, 216, 226, 46, 219, 11, 230, 187, 37, 245, 34, 194, 24, 6, 21, 145, 134,
        239, 19, 202, 77, 226, 96, 247, 100, 102, 133, 80]
...
@testset "OKP Ed25519 Good" begin
    cose_b = UInt8[164, 1, 1, 3, 39, 32, 6, 33, 88, 32, 33, 245, 65, 233, 205,
        194, 180, 45, 83, 65, 7, 159, 184, 66, 190, 92, 78, 231, 70, 224, 98, 200,
        255, 196, 206, 16, 229, 174, 84, 34, 68, 201]
    cose = CBOR.decode(cose_b)
    key = cose_key_parse(cose)
